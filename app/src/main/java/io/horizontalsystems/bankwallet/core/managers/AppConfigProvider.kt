...
class AppConfigProvider : IAppConfigProvider, ILanguageConfigProvider, IAppConfigTestMode {
    ...
    override val appWebPageLink: String = "https://app.waltonchain.org/app-h5/wtc_download"
    override val reportEmail = "wallet@waltonchain.org"
    override val walletHelpTelegramGroup = "Waltonchain_official"
    override val developersTelegramGroup = "waltonchain_development"
...
//            Coin("BTC",       "Bitcoin",                 "BTC",          8,      CoinType.Bitcoin),
            Coin("WTC",       "Waltonchain",             "WTC",         18,      CoinType.Ethereum),
...
//            Coin("USDC",      "USD Coin",                "USDC",         6,      CoinType.Erc20("0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48")),
            Coin("WTA",       "Waltonchain Autonomy",    "WTA",         18,      CoinType.Erc20("0x668df218d073f413Ed2FCEa0D48CfbFd59C030Ae"))
    )
